...
The modified version of this script will:
- Scrape an RSS feed once a day
- Store it at a timestamp
- Then pre-prompted LLMs with different "personas" will look at the RSS feed :)
...
6. Find an RSS Feed (e.g. [Google News RSS](https://news.google.com/rss?hl=en-US&gl=US&ceid=US:en)).
